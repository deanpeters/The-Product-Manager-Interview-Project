...
### AI — Optional layer, AI-heavy roles only

`Questions/ai/` is a domain-based folder rather than a format-based one — see [ai-competency-model.md](ai-competency-model.md) for when to use it. Each card still has its own format Type (noted below) even though it isn't foldered by format like the rest of the bank.

- [Explaining AI Limits to a Skeptic](../Questions/ai/Explaining-AI-Limits-to-a-Skeptic.md) — Method
- [Where AI Actually Helps](../Questions/ai/Where-AI-Actually-Helps.md) — Judgment
- [Testing an AI Idea Before It's Real](../Questions/ai/Testing-an-AI-Idea-Before-Its-Real.md) — Judgment
- [What the Model Needs to Know](../Questions/ai/What-the-Model-Needs-to-Know.md) — Judgment
...
- [When Growth Could Harm Customers](../Questions/judgment/When-Growth-Could-Harm-Customers.md)
- [The Business Case Behind the Ask](../Questions/judgment/The-Business-Case-Behind-The-Ask.md)
- [When the Model Is Wrong](../Questions/ai/When-the-Model-Is-Wrong.md)
- [Turning Usage Into a Better Model](../Questions/ai/Turning-Usage-Into-a-Better-Model.md)
- [One Signal Up, Another Down](../Questions/judgment/One-Signal-Up-Another-Down.md)
...
- **AI Fundamentals** — [Explaining AI Limits to a Skeptic](../Questions/ai/Explaining-AI-Limits-to-a-Skeptic.md)
- **AI Opportunity Discovery** — [Where AI Actually Helps](../Questions/ai/Where-AI-Actually-Helps.md)
- **AI Product Discovery & Validation** — [Testing an AI Idea Before It's Real](../Questions/ai/Testing-an-AI-Idea-Before-Its-Real.md)
- **Data & Context Strategy** — [What the Model Needs to Know](../Questions/ai/What-the-Model-Needs-to-Know.md)
