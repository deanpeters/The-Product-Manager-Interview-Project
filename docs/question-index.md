...
- [Dealing with Seismic Paradigm Shifts](../Questions/behavioral/Dealing-with-Seismic-Paradigm-Shifts.md)
- [The Feature That Wasn't the Problem](../Questions/behavioral/Feature-That-Wasnt-The-Problem.md)
...
- [Deciding Before You're Certain](../Questions/judgment/Deciding-Before-Youre-Certain.md)
- [Shipped, But Didn't Work](../Questions/judgment/Shipped-But-Didnt-Work.md)
- [Reading Market Signals](../Questions/judgment/Reading-Market-Signals.md)
- [When Growth Could Harm Customers](../Questions/judgment/When-Growth-Could-Harm-Customers.md)
- [Assumptions Worth Testing First](../Questions/judgment/Assumptions-Worth-Testing-First.md)
- [Ten Problems, One Focus](../Questions/judgment/Ten-Problems-One-Focus.md)
...
- [Where AI Actually Helps](../Questions/judgment/Where-AI-Actually-Helps.md) — AI competency
- [Testing an AI Idea Before It's Real](../Questions/judgment/Testing-an-AI-Idea-Before-Its-Real.md) — AI competency
- [What the Model Needs to Know](../Questions/judgment/What-the-Model-Needs-to-Know.md) — AI competency
- [How Much Should the AI Decide](../Questions/judgment/How-Much-Should-the-AI-Decide.md) — AI competency
- [When the Model Is Wrong](../Questions/judgment/When-the-Model-Is-Wrong.md) — AI competency
- [The Line You Wouldn't Cross](../Questions/judgment/The-Line-You-Wouldnt-Cross.md) — AI competency
...
See [competency-model.md](competency-model.md) for definitions. Most cards assess more than one competency; each is listed under every competency it names, not just its primary one. AI-competency cards are included here too, under the core competency they map to.
...
- [A Critique You'd Stand Behind](../Questions/judgment/A-Critique-Youd-Stand-Behind.md)
- [Assumptions Worth Testing First](../Questions/judgment/Assumptions-Worth-Testing-First.md)
- [Testing an AI Idea Before It's Real](../Questions/judgment/Testing-an-AI-Idea-Before-Its-Real.md)
...
- [Separating a Funded Move From a Narrated One](../Questions/judgment/Separating-a-Funded-Move-From-a-Narrated-One.md)
- [A Critique You'd Stand Behind](../Questions/judgment/A-Critique-Youd-Stand-Behind.md)
- [Explaining AI Limits to a Skeptic](../Questions/method/Explaining-AI-Limits-to-a-Skeptic.md)
- [Where AI Actually Helps](../Questions/judgment/Where-AI-Actually-Helps.md)
...
- [When Growth Could Harm Customers](../Questions/judgment/When-Growth-Could-Harm-Customers.md)
- [The Business Case Behind the Ask](../Questions/judgment/The-Business-Case-Behind-The-Ask.md)
- [When the Model Is Wrong](../Questions/judgment/When-the-Model-Is-Wrong.md)
- [Turning Usage Into a Better Model](../Questions/judgment/Turning-Usage-Into-a-Better-Model.md)
...
See [ai-competency-model.md](ai-competency-model.md). Only use these for roles where AI is a real part of the product surface.

- **AI Fundamentals** — [Explaining AI Limits to a Skeptic](../Questions/method/Explaining-AI-Limits-to-a-Skeptic.md)
- **AI Opportunity Discovery** — [Where AI Actually Helps](../Questions/judgment/Where-AI-Actually-Helps.md)
- **AI Product Discovery & Validation** — [Testing an AI Idea Before It's Real](../Questions/judgment/Testing-an-AI-Idea-Before-Its-Real.md)
- **Data & Context Strategy** — [What the Model Needs to Know](../Questions/judgment/What-the-Model-Needs-to-Know.md)
- **AI Experience & Human Agency** — [How Much Should the AI Decide](../Questions/judgment/How-Much-Should-the-AI-Decide.md)
- **AI Evaluation & Metrics** — [When the Model Is Wrong](../Questions/judgment/When-the-Model-Is-Wrong.md)
- **AI Risk, Safety & Responsible Use** — [The Line You Wouldn't Cross](../Questions/judgment/The-Line-You-Wouldnt-Cross.md)
...
Update this file whenever a question file is added, moved, retired, or rewritten. See [CONTRIBUTING.md](../CONTRIBUTING.md) for the process.
