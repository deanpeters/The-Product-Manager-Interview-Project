...
### `~/Code/15-days-of-aipm/substack/deanpeters.substack.com/*.md` (external to `Research/`, not copied in) — Publicly published, real citations used

Not a file in this repository's `Research/` folder — a separate local checkout of Dean Peters's own public Substack publication, *Confessions of a Feature Factory Escapee* (deanpeters.substack.com), read directly from its own path for a mining pass. ~75 essays, including the "15 Days of AI PM" series. Like the Dangerous Animals ebook and ProductCamp transcript above, this is genuinely public, real-name-attributed work by the repository owner, not a private tool or internal document. Six essays were mined for interview-card angles the existing AI-competency layer didn't cover: [Which Customer Said This?](../Questions/ai/Which-Customer-Said-This.md) (Day 06 — AI-fabricated research synthesis), [Kill the Zombie Pilot](../Questions/ai/Kill-the-Zombie-Pilot.md) ("Finally, an AI Product Operating Model" — portfolio-level stop decisions), [The Lever the CFO Can See](../Questions/ai/The-Lever-the-CFO-Can-See.md) (Day 14 — finance-legible AI value), [Twelve Tabs, Twelve Truths](../Questions/ai/Twelve-Tabs-Twelve-Truths.md) (Day 05 — context engineering as a team practice), [Frankensoft or AI-First](../Questions/ai/Frankensoft-or-AI-First.md) (Day 08 — bolt-on vs. redesign), and [The Storm You Could See in Week One](../Questions/ai/The-Storm-You-Could-See-in-Week-One.md) (Day 12 — internal AI-project risk, distinct from the existing card's external/regulatory lens). A later review found that some AI cards adapted from the internal competency model still need a stronger Substack-informed rewrite, especially around AI as a multiplier, tool-strategy half-life, context as infrastructure, eval traces/thresholds, agent journey maps, and economic levers. Each public essay citation should continue to use the essay title and publication root domain unless an individual post URL has been verified stable.
...
- Dean Peters's Substack (`deanpeters.substack.com`, mined from a local checkout outside `Research/`) — genuinely public, real-name-attributed essays; cited by title with a root-domain link since individual post slugs weren't verified stable enough to deep-link.
